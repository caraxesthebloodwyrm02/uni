...
def main():
    ...
    parser.add_argument("--recursive-check", type=str, default="true", help="Enable recursive directory scanning")
    parser.add_argument("--depth", type=int, default=5, help="Recursive tree depth limit")
    parser.add_argument("--scope", type=str, default="all", help="Target specific scopes (or 'all')")
    ...
    print(f"Initiating heavy recursive guardrail check (Depth: {args.depth}, Scope: {args.scope})...")
