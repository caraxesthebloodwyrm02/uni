...
- The live tree is documented as a stub. Materialising Apache-2.0 LICENSE +
  NOTICE in a stub is technically legal but creates an attestation that the
  canonical archive may not yet reflect.
...
- Materialise Apache-2.0 LICENSE file at repo root matching pyproject.toml:16.
- Materialise NOTICE per Apache-2.0 §4a naming canonical volume + live UID.
